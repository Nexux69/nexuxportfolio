    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        >
          ...
          >
            <span className="text-cyan-400">AI & Data Science Engineer</span>
          ...
          >
            <Button
              ...
              className="bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-600 hover:to-purple-700 text-white px-8 py-3 rounded-full text-lg font-medium transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/25"
            >
              View My Work
            </Button>
          </motion.div>
        ...
        >
          <ChevronDown className="w-8 h-8 text-cyan-400 opacity-70" />
        </motion.div>
      </div>
    </section>
  );
